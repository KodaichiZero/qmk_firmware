...
#    define RGBLIGHT_LIMIT_VAL 144 /* The maximum brightness level */
...
//     ==========================
#        define ENABLE_RGB_MATRIX_KZ_CUSTOM
#        define ENABLE_RGB_MATRIX_KZ_EXPANDING_CIRCLES
//#        define ENABLE_RGB_MATRIX_GRADIENT_UP_DOWN_FRAMED
//#        define ENABLE_RGB_MATRIX_BREATHING_SMILE
#        define ENABLE_RGB_MATRIX_CYCLE_LEFT_RIGHT_QUARTER
